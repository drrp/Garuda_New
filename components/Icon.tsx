...
interface IconProps {
  // Fix: Add 'google' to the list of available icon names.
  name: 'copy' | 'check' | 'check-circle' | 'loading' | 'sparkles' | 'download' | 'code' | 'trash' | 'history' | 'close' | 'dev' | 'chevron-down' | 'book-open' | 'document-text' | 'search' | 'edit' | 'arrow-right' | 'menu' | 'home' | 'google' | 'stop' | 'reset' | 'key';
  className?: string;
}
...
const icons: Record<IconProps['name'], React.ReactNode> = {
  ...
  loading: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v.01M12 21v-.01M4.22 4.22l.01.01M19.78 19.78l-.01-.01M3 12h.01M21 12h-.01M4.22 19.78l.01-.01M19.78 4.22l-.01.01" />
    </svg>
  ),
  sparkles: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
